export type InterfaceType = [{ path: "/api/base/sub"; method: "post"; input: { a: number; b: number; }; successOutput: { status: "success"; data: { res: number; }; }; errorOutput: { status: "fail"; data: "未知错误"; }; },{ path: "/api/base/add"; method: "post"; input: { a: number; b: number; }; successOutput: { status: "success"; data: { res: number; }; }; errorOutput: { status: "fail"; data: "未知错误"; }; },{ path: "/api/user/register"; method: "post"; input: { name: string; pwd: string; }; successOutput: { status: "success"; data: {}; }; errorOutput: { status: "fail"; data: "未知错误" | "用户名已存在"; }; },{ path: "/api/user/login"; method: "post"; input: { name: string; pwd: string; }; successOutput: { status: "success"; data: { token: string; }; }; errorOutput: { status: "fail"; data: "未知错误" | "用户不存在" | "密码错误"; }; },{ path: "/api/user/is-login"; method: "post"; input: {}; successOutput: { status: "success"; data: { isLogin: boolean; }; }; errorOutput: { status: "fail"; data: "未知错误"; }; },{ path: "/api/base/upload-file"; method: "post"; input: {}; successOutput: { status: "success"; data: {}; }; errorOutput: { status: "fail"; data: "未知错误"; }; },{ path: "/api/user/login"; method: "post"; input: { name: string; pwd: string; }; successOutput: { status: "success"; data: { token: string; }; }; errorOutput: { status: "fail"; data: "未知错误" | "用户不存在" | "密码错误"; }; }]
