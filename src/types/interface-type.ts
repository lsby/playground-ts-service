export type InterfaceType = [{ path: "/api/base/sub"; method: "post"; input: { a: number; b: number; }; successOutput: { res: number; }; errorOutput: never; },{ path: "/api/base/add"; method: "post"; input: { a: number; b: number; }; successOutput: { res: number; }; errorOutput: never; },{ path: "/api/user/register"; method: "post"; input: { name: string; pwd: string; }; successOutput: { state: "success"; }; errorOutput: { state: "fail"; error: "用户名已存在"; }; },{ path: "/api/user/login"; method: "post"; input: { name: string; pwd: string; }; successOutput: { state: "success"; token: string; }; errorOutput: { state: "fail"; error: "用户名或密码错误"; }; },{ path: "/api/user/is-login"; method: "post"; input: {}; successOutput: { isLogin: boolean; }; errorOutput: never; },{ path: "/api/base/upload-file"; method: "post"; input: {}; successOutput: {}; errorOutput: never; }]
