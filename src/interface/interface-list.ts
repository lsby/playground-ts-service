...
import _src_interface_demo_user_crud_inser_index_ts from './demo/user-crud/inser/index'
import _src_interface_demo_user_crud_select_index_ts from './demo/user-crud/select/index'
...
export let interfaceApiList: 任意接口[] = [
  ...
  _src_interface_demo_user_crud_inser_index_ts,
  _src_interface_demo_user_crud_select_index_ts,
